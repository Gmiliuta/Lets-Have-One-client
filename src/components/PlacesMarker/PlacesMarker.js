...
function PlacesMarker ({place_id, location, name, myLocation }) {
  ...
  return (
    ...
    >
      {visibleInfoBox && <SlideWindow place_id={place_id} location={location} name={name} hideInfo={hideInfo} getDirection={getDirection}/>}
